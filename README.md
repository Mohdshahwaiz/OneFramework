...
<dependency>
  <groupId>io.github.oneframeworkio.github.oneframework</groupId>
...
This is the configuration file for One Framework named `boyka-config.json` stored at `src/test/resources` folder.

```json
{
  "listeners_package": "io.github.oneframework.testng.listeners",
  "ui": {
    "timeout": {
      "implicit_wait": 10,
      "explicit_wait": 10,
...
verifySchema ("create-user-schema.json");
